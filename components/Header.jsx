  ...
  return (
    <header className="site-header">
      <div className="announcement">
        <span>{siteContent.establishedLabel}</span>
        <span>{siteContent.contact.phone}</span>
        {siteContent.contact.secondaryPhone ? <span>{siteContent.contact.secondaryPhone}</span> : null}
      ...
      <div className="brand-row">
        ...
        <button className="menu-toggle" onClick={() => setOpen(!open)} aria-expanded={open} aria-label={ui.menu}>
